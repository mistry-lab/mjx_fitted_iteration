...
def forward(m: Model, d: Data) -> Data:
  ...
  """
  CHANGE - USING solver.implicit_jaxopt.solve NOT solver.solve 
  # Use os environ to change the solver
  """
  import os
  MJX_SOLVER = os.environ.get("MJX_SOLVER")
 
  if MJX_SOLVER == "implicit_jaxopt":
    d = solver.implicit_jaxopt_solve(m, d)
  elif MJX_SOLVER == "implicit_lax":
    d = solver.implicit_lax_solve(m, d)
  else:

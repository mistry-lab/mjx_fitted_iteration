...
if __name__ == "__main__":
    ...
    nn = PolicyNet([6, 128, 128, 1], key=jax.random.PRNGKey(0))
    ...
    optimal_nn = optimizer.solve(nn, adam, opt_state, max_iter=65)
    ...
    x, cost = simulate_trajectory(mx, qpos_init, set_control, running_cost, terminal_cost, params, static, Nsteps)

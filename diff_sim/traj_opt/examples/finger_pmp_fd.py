...
import equinox
from diff_sim.traj_opt.pmp_fd import PMP, make_loss
...
if __name__ == "__main__":
    ...
    loss_fn = make_loss(mx, qpos_init, running_cost, terminal_cost)
    ...
    x, cost = simulate_trajectory(mx, qpos_init, running_cost, terminal_cost, optimal_U)
